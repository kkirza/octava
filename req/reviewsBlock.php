<div class="reviews">
    <div class="reviews__container">
        <div class="reviews__textArea Mont_Heavy_MA">
            <div class="reviews__headline Up-c_MA">Отзывы</div>
            <div class="reviews__subtitle Up-c_MA">Гордимся каждым учеником</div>
            <div class="reviews__text Inter_Light_MA">В Октаве каждый ученик получит опыт живых выступлений</div>
        </div>
    </div>


    <div class="reviews__videoArea__container">
        <div class="reviews__videoArea">

            <div class="reviews__videoBlock IndexTeacherInfo__MA__slider-block__blue bg_opt_all_MA">
    ...
    <div class="reviewsController">
        <div class="reviewsController__buttons">
            <img src="img/IndexTeacherInfo__MA__slider_next.svg" class="reviewsController__buttons-Button reviewsController__buttons-Button__prev">
            <img src="img/IndexTeacherInfo__MA__slider_next.svg" class="reviewsController__buttons-Button reviewsController__buttons-Button__next">
        </div>
        <a class="reviewsButton Mont_Heavy_MA" href="reviews.php">посмотреть все отзывы</a>
    </div>
