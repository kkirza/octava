...
<style>
    .IndexTeacherInfo__MA__slider-blockIMG__container{height: 320px; width: 317px; position: relative; overflow: hidden; transition: .3s}
    .IndexTeacherInfo__MA__slider-blockIMG{width: 317px; height: auto;position: absolute; top: 0; left: 0; border-radius: 10px;}
...
<div class="teachersSlider__teacher IndexTeacherInfo__MA__slider-block__orange teachersSlider__teacher__VOCAL">
    <div class="IndexTeacherInfo__MA__slider-block__container" >
        ...
        <div class="IndexTeacherInfo__MA__slider-block__linkArea"><a class="IndexTeacherInfo__MA__slider-block__link IndexTeacherInfo__MA__slider-block__link__KARPOVA">Подробнее</a><img src="img/IndexTeacherInfo__MA__slider-block__link-arrow.svg" class="IndexTeacherInfo__MA__slider-block__link-arrow"></div>
    </div>
</div>
<div class="teachersSlider__teacher IndexTeacherInfo__MA__slider-block__orange teachersSlider__teacher__VOCAL ">
    <div class="IndexTeacherInfo__MA__slider-block__container">
        ...
        <div class="IndexTeacherInfo__MA__slider-block__linkArea"><a class="IndexTeacherInfo__MA__slider-block__link IndexTeacherInfo__MA__slider-block__link__SMIRNOVA">Подробнее</a><img src="img/IndexTeacherInfo__MA__slider-block__link-arrow.svg" class="IndexTeacherInfo__MA__slider-block__link-arrow"></div>
    </div>
</div>
<div class="teachersSlider__teacher IndexTeacherInfo__MA__slider-block__orange teachersSlider__teacher__VOCAL">
    <div class="IndexTeacherInfo__MA__slider-block__container">
        ...
        <div class="IndexTeacherInfo__MA__slider-block__linkArea"><a class="IndexTeacherInfo__MA__slider-block__link IndexTeacherInfo__MA__slider-block__link__KUZNECOVA">Подробнее</a><img src="img/IndexTeacherInfo__MA__slider-block__link-arrow.svg" class="IndexTeacherInfo__MA__slider-block__link-arrow"></div>
    </div>
</div>IndexTeacherInfo__MA__slider-block__link
<div class="teachersSlider__teacher IndexTeacherInfo__MA__slider-block__blue teachersSlider__teacher__GUITAR">
    <div class="IndexTeacherInfo__MA__slider-block__container">
        <div class="IndexTeacherInfo__MA__slider-blockIMG__container">
        ...
        <div class="IndexTeacherInfo__MA__slider-block__linkArea"><a class="IndexTeacherInfo__MA__slider-block__link IndexTeacherInfo__MA__slider-block__link__TARASOV">Подробнее</a><img src="img/IndexTeacherInfo__MA__slider-block__link-arrow.svg" class="IndexTeacherInfo__MA__slider-block__link-arrow"></div>
    </div>
</div>
<div class="teachersSlider__teacher IndexTeacherInfo__MA__slider-block__blue teachersSlider__teacher__GUITAR">
    <div class="IndexTeacherInfo__MA__slider-block__container">
        ...
        <div class="IndexTeacherInfo__MA__slider-block__linkArea"><a class="IndexTeacherInfo__MA__slider-block__link IndexTeacherInfo__MA__slider-block__link__LAZO">Подробнее</a><img src="img/IndexTeacherInfo__MA__slider-block__link-arrow.svg" class="IndexTeacherInfo__MA__slider-block__link-arrow"></div>
    </div>
</div>
<div class="teachersSlider__teacher IndexTeacherInfo__MA__slider-block__violet teachersSlider__teacher__DRUMS">
    <div class="IndexTeacherInfo__MA__slider-block__container">
        <div class="IndexTeacherInfo__MA__slider-blockIMG__container">
        ...
        <div class="IndexTeacherInfo__MA__slider-block__linkArea"><a class="IndexTeacherInfo__MA__slider-block__link IndexTeacherInfo__MA__slider-block__link__POPOV">Подробнее</a><img src="img/IndexTeacherInfo__MA__slider-block__link-arrow.svg" class="IndexTeacherInfo__MA__slider-block__link-arrow"></div>
    </div>
</div>
<div class="teachersSlider__teacher IndexTeacherInfo__MA__slider-block__violetLight teachersSlider__teacher__DRUMS">
    <div class="IndexTeacherInfo__MA__slider-block__container">
        <div class="IndexTeacherInfo__MA__slider-blockIMG__container">
        ...
        <div class="IndexTeacherInfo__MA__slider-block__linkArea"><a class="IndexTeacherInfo__MA__slider-block__link IndexTeacherInfo__MA__slider-block__link__PORTNOV">Подробнее</a><img src="img/IndexTeacherInfo__MA__slider-block__link-arrow.svg" class="IndexTeacherInfo__MA__slider-block__link-arrow"></div>
    </div>
</div>
<div class="teachersSlider__teacher IndexTeacherInfo__MA__slider-block__blueLight teachersSlider__teacher__KEYS">
    <div class="IndexTeacherInfo__MA__slider-block__container">
        <div class="IndexTeacherInfo__MA__slider-blockIMG__container">
        ...
        <div class="IndexTeacherInfo__MA__slider-block__linkArea"><a class="IndexTeacherInfo__MA__slider-block__link IndexTeacherInfo__MA__slider-block__link__KALACHINA">Подробнее</a><img src="img/IndexTeacherInfo__MA__slider-block__link-arrow.svg" class="IndexTeacherInfo__MA__slider-block__link-arrow"></div>
    </div>
</div>