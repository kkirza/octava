...
<div class="schoolOfMusic_MA">
    ...
    <div class="schoolOfMusic_MA__mainContent">
        ...
        <form class="schoolOfMusic_MA__form sendFORM">
            ...
            <input type="checkbox" class="checkbox-b_MA" id="schoolOfMusic_MA-checkbox" required><label for="schoolOfMusic_MA-checkbox" class="checkbox-b_MA_label Inter_semi_bold_MA">Я даю согласие на обработку персональных данных</label>
            </div>
        </form>
    </div>
                ...
                <div class="ourAtmosphere__content_flexZone">
                    <div class="ourAtmosphere__content_flexZone-left">
                        ...
                        <form class="main_form_MA sendFORM" action="send.php" method="post">
                            ...
                            <div class="schoolOfMusic_MA__form-checkboxArea">
                                <input type="checkbox" class="checkbox-b_MA" id="toPerformance_MA-checkbox" required><label for="toPerformance_MA-checkbox" class="checkbox-b_MA_label Inter_semi_bold_MA">Я даю согласие на обработку персональных данных</label>
                            </div>
                        </form>
            ...
            <div class="FAQ_MA__content">
                ...
                <div class="FAQ_MA__1500-flex">
                    ...
                    <div class="FAQ_MA__materials">
                        ...
                        <div class="FAQ_MA__materials__block-content">
                            ...
                            <div class="FAQ_MA__materials__block-content__answer">Через 4 занятия наши ученики уже исполняют свою первую песню. Но тут все зависит от тебя.
                                <p>Приходи на бесплатное пробное занятие и наш учитель составит путь твоего развития.</p></div>
                        </div>
                    ...
                    <form class="FAQ-form sendFORM" action="send.php" method="post">
                        ...
                        <div class="schoolOfMusic_MA__form-checkboxArea">
                            <input type="checkbox" class="checkbox-b_MA" id="FAQ-checkbox" required><label for="FAQ-checkbox" class="checkbox-b_MA_label Inter_semi_bold_MA">Я даю согласие на обработку персональных данных</label>
                        </div>
                    </form>
                </div>
