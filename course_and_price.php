...
<?php require('req/timerPOPUP.php')?>
    ...
    <div class="container__1500__ZK">
        ...
        <style>
            ...
            .singleSubscription__headline {
                font-size: 16px;
            }

            .singleSubscription__headline__2 {
                margin-left: 117px;
                font-size: 64px;
                max-width: 536px
            }

            .singleSubscriptionIMG {
                position: absolute;
                width: 551px;
                height: 191px;
                left: 180px;
            ...
            .singleSubscription__block {
                max-width: 727px;
                background: white;
                border-radius: 10px
            }

            .singleSubscription__block__bg {
                background: url("img/singleSubscriptionBG.png");
                background-size: cover;
                background-repeat: no-repeat
            }

            .singleSubscription__block__mg {
                margin-top: 15px
            }

            .singleSubscription__block__blockHeadline {
                font-size: 24px
            }

            .singleSubscription__block_container {
                margin-left: 15px;
                padding-top: 15px;
                padding-bottom: 15px
            }

            .singleSubscription__block__blockSubtitle {
                font-size: 16px;
                margin-top: 0;
            }

            .singleSubscription__block__priceZone {
                margin-top: 15px;
                display: flex;
            }

            .singleSubscription__block__priceString {
                display: flex
            }

            .singleSubscription__block__priceString2 {
                display: flex;
                margin-top: 0
            }

            .singleSubscription__block__priceString__headline {
                font-size: 24px
            }

            .singleSubscription__block__priceString__number {
                font-size: 24px;
                margin-left: 60px
            }

            .singleSubscription__block__priceString___priceName {
                font-size: 16px
            }

            .singleSubscription__block__priceString___price {
                font-size: 16px;
                margin-left: 114px
            }

            .singleSubscription__button {
                background: #3B32F5;
                display: flex;
            ...
            .singleSubscription__block__priceLeft {
                padding-right: 65px;
                border-right: 1px solid #e3e3e3
            }

            .singleSubscription__block__priceRight {
                margin-left: 60px
            }

            .singleSubscription__priceContainer-mobile {
                display: none
            }
            ...
            @media (max-width: 670px) {
                ...
                .singleSubscription__block__bg {
                    background: url("img/singleSubscriptionBG-mobile.png");
                    background-size: cover;
                    background-repeat: no-repeat
                }

                .singleSubscription__priceContainer-mobile__block__mg {
                    margin-top: 20px
                }
                ...
                .singleSubscription__priceContainer-mobile__headline {
                    max-width: 340px;
                    font-size: 28px;
                    line-height: 120%
                }

                .singleSubscription__priceContainer-mobile__subtitle {
                    font-size: 14px;
                    line-height: 130%;
                    margin-top: 0
                }
                ...
                .singleSubscription__priceContainer-mobile__content__right-string1 {
                    font-size: 30px
                }

                .singleSubscription__priceContainer-mobile__content__right-string2 {
                    font-size: 16px;
                    margin-top: -7px
                }

                .singleSubscription__priceContainer-mobile__content {
                    display: flex;
                    margin-top: 10px
                }

                .singleSubscription__priceContainer-mobile__content__headline {
                    font-size: 18px
                }

                .singleSubscription__priceContainer-mobile__content__right {
                    margin-left: 70px;
                    margin-top: -10px
                }
            }
        ...
        <style>
            ...
            .course__where__pass__lesson__container {
                margin: 100px 10px 100px 10px;
            }

            .course__text__wpl__main__title {
                margin-bottom: 50px;
                font-size: 64px;
                line-height: 120%;
            ...
            .course__wpl__obj__left,
            .course__wpl__obj__right {
                max-width: 230px;
                font-family: "Inter_light_MA"
            }

            .course__wpl__contacts__container {
                width: fit-content;
                padding: 20px;
            ...
            .course__wpl__contacts__description {
                margin-bottom: 30px;
                font-weight: 300;
                font-size: 16px;
                line-height: 130%;
            ...
            .course__wpl__right img:not(:last-child) {
                margin-bottom: 30px;
            }

            .course__wpl__right img {
                border-radius: 20px;
                max-width: 725px;
                width: 100%;
            }
            ...
            .course__wpl__left__write__there {
                margin-bottom: 5px;
                font-size: 24px;
                line-height: 120%;
                text-transform: uppercase;
            ...
            .course__wpl__obj__right span {
                font-weight: bold
            }

            .course__wpl__block__mess {
                display: flex;
                align-items: center;
                gap: 15px;
            }

            .course__wpl__block__mess svg path {
                transition: fill .3s ease
            }

            .course__wpl__block__mess svg path:hover {
                fill: #3B32F5;
                cursor: pointer;
                transition: fill .3s ease
            }
